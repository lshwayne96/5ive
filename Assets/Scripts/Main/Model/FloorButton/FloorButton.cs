...
namespace Main.Model.FloorButton {
	...
	/// </remarks>
	public class FloorButton : RestorableMonoBehaviour {
		...
		public override void RestoreWith(Data data) {
			FloorButtonData floorButtonData = (FloorButtonData) data;
			floorButtonData.RebuildCompoundTypes();

			startPosition = floorButtonData.prevStartPosition;
			EndPosition = floorButtonData.prevEndPosition;
			OriginalStartPosition = floorButtonData.originalStartPosition;
			OriginalEndPosition = floorButtonData.originalEndPosition;

			MovementDirection = floorButtonData.movementDirection;
			IsDown = floorButtonData.isDown;
			IsMoving = floorButtonData.isMoving;

			WaitDuration = floorButtonData.waitDuration;
			OriginalWaitDuration = floorButtonData.originalWaitDuration;
