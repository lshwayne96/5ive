...
namespace Main.Model.Lever {

	/// <summary>
	/// This script represents a lever and its interactions.
	/// </summary>
	public class Lever : RestorableMonoBehaviour {
	    ...
	    */
		...
		public override Data Save() {
			return new LeverData(this);
		}

		public override void RestoreWith(Data data) {
			LeverData leverData = (LeverData) data;
			leverData.RebuildCompoundTypes();

			startRotation = leverData.prevStartRotation;
			EndRotation = leverData.prevEndRotation;
			OriginalStartRotation = leverData.originalStartRotation;
			OriginalEndRotation = leverData.originalEndRotation;
			MovementDirection = leverData.movementDirection;
			HasSwitchedRotation = leverData.hasSwitchedRotation;
			IsRotating = leverData.isRotating;
			hasInitialised = true;
